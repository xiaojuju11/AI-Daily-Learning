...
**AI-Daily-Learning** 是一个系统化的 **AI 应用开发、大模型工程落地与现代全栈开发（React + TS + Node）** 的日常学习与实战沉淀仓库。

本项目从零到一构建了一套从 **LLM 核心原理、MCP 协议、Agent 架构** 到 **现代前端深度进阶、大厂面试硬核手写与高并发性能优化** 的完整知识库与项目代码。
